...
<tr bgcolor="#dddddd">
	<td><b>Добавить логин в пополнения</b> **:</td>
	<td align="right"><input style="width: 200px;" type="text" name="fakeenterlogin" size="70" maxlength="30" value="" /></td>
        <td align="right"><input style="width: 75px;" type="text" name="fakeentersum" placeholder='сумма' size="70" maxlength="30" value="" /></td>
</tr>
<tr bgcolor="#dddddd">
	<td><b>Добавить логин в выводы</b> **:</td>
	<td align="right"><input style="width: 200px;" type="text" name="fakewithlogin" size="70" maxlength="30" value="" /></td>
        <td align="right"><input style="width: 75px;" type="text" name="fakewithsum" placeholder='сумма' size="70" maxlength="30" value="" /></td>
</tr>
