	...
	if(!mysql_num_rows(mysql_query("SELECT * FROM captcha WHERE sid = '".$sid."' AND ip = '".getip()."' AND code = '".$code."'"))) {
		...
		if (!$a) {
			...
			if (mail($email,$subject,$text,$headers)) {
				print '<p class="erok">Новый пароль был выслан на Ваш E-mail! Письма могут попасть в папку спам.</p>';
			} else {
...
<h1>Восстановление пароля</h1><form method="post" action="index.php" name="login_frm"><fieldset><table class="formatTable">				<tbody><tr>							<td><label for="login_frm_Login"><span class="descr_req">Логин<span class="descr_star">*</span></span></label></td><td><input name="ulogin" id="login_frm_Login" value="" size="20" type="text" class="string_small"></td></tr><tr>							<td><label for="login_frm_Login"><span class="descr_req">E-mail<span class="descr_star">*</span></span></label></td><td><input name="uemail" id="login_frm_Login" value="" size="20" type="text" class="string_small"></td></tr>				<tr>										<td><label for="login_frm_Pass"><span class="descr_req">Код с картинки <img src="/captcha.php" width="70" height="25" border="0"><span class="descr_star"></span></span></label></td><td><input name="code" id="login_frm_Pass" value="" size="20" type="text" class="password"></td></tr>								</tbody></table></fieldset><input name="grgr" value="e08373d6" type="hidden"><br><input name="gtt" value="Восстановить" type="submit" class="button-blue"></form><br>