...
Error_Reporting(0);
	...
	$mysql_login			          = "ferma";		   // Логин к БД
	$mysql_password			          = "ferma";	           // Пароль к БД
	$database				  = "ferma";               // База данных
	$num					  = 10;			           // Кол-во выводов на страницу
	$cfgURL					  = "forexup.org";	   // URL ресурса
	$chmod					  = "755";                         // Права папкам на запись
        #--------------------------Other settings------------------------------#
        $title_ru                                 = "ForexUP";                            // Заголовок проекта ru
        $title_en                                 = "ForexUP";                            // Заголовок проекта en
