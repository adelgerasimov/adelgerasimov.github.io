...
if($error == 1) {
$ppass = $_POST['pass'];
	print "<center><p class=\"erok\"><div align='center'>Congratulations! You registered. Please write your data!<br><table><tr><td>Your login: <b>$ulogin</b></td></tr><tr><td>Your password: <b>$ppass</b></td></tr><tr><td><a href='/login/'><input value='Войти' type='submit' class='button_blue'></a></td></tr></table></p></div>";
